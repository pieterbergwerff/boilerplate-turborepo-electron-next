...
import type { ButtonAtomPropTypes } from '@packages/types';

/**
 * Reusable button component with OS-specific styling.
 * @param {ButtonAtomPropTypes} props Component props
 * @returns {JSX.Element} Rendered button
 */
export const ButtonAtomComponent = ({
  children,
  variant = 'primary',
  onClick,
  disabled = false,
}: ButtonAtomPropTypes): JSX.Element => {
  const baseStyles =
