...
import type { SelectMoleculePropTypes } from '@packages/types';

/**
 * Select dropdown component with OS-specific styling.
 * @param {SelectMoleculePropTypes} props Component props
 * @returns {JSX.Element} Select element
 */
export const SelectMoleculeComponent = ({
  options,
  value,
  onChange,
  placeholder = 'Select...',
  disabled = false,
}: SelectMoleculePropTypes): JSX.Element => {
  const osStyles = [
